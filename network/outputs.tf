...
output "control_plane_subnet_name_list" {
  value = module.vpc.control_plane_subnet_name_list
}
...
output "compute_subnet_name_list" {
  value = module.vpc.compute_subnet_name_list
}
